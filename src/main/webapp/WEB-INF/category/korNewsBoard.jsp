...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/korBestBoard.css">
    </head>
    <body>
                            ...
                            <section id="loginTag">
                                ...
                                <section id="noticeTable">
                                    <table border="1">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td><a href="../posting/korNewsPosting.html"> '확 바뀐 얼굴, 더 바뀐 실내' 렉스턴 스포츠 칸 쿨멘</a> [2]</td>
                                            <td>도봉구보안관</td>
                                            <td>2023.06.04</td>
                                            <td>1</td>
                                            <td>5</td>
    ...
    <script>
            ...
            document.querySelector("#noticeBtn7").addEventListener("click",()=>{
                location.href="../writing/kornewsw.html"
            })
