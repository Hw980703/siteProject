...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/writingChange.css">
    </head>
    <body>
                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">수입차 - 해외 자동차 뉴스</article>
                                ...
                                <section id="writing">
                                    <article id="writingtop">
                                        ...
                                        <select name="writeSel" id="writeSel">
                                            <option value="global">수입차</option>
                                            <option value="kor">국산차</option>
                                        ...
                                        <select name="writeSel" id="writeSel">
                                            ...
                                            <option value="kor">해외 자동차 뉴스</option>
                                        
                                        </select>
                                    </article>
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="람보르기니 우루스 퍼포만테 한정판 에디션 공개!" placeholder="제목을 입력하세요.">
                                    </article>
                                    <article id="writingMain">
                                        <article id="writingMainSub">
                                            <article id="textEdit">
                                                 <img src="../../텍스트에디터.png" width="100%" alt="textEdit">
                                            </article>
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/globalnewswrite.jpg" width="40%" alt="globalnews">
                                               <pre>  우루스 퍼포만테는 람보르기니의 슈퍼 SUV 제품군 중 가장 스포티하고 높은 성능을 발휘하는 모델이다.
  666CV의 출력과 850Nm의 최대 토크, 트윈터보 V8 엔진 덕분에 3.3초만에 시속 0km 에서 100km까지 도달할 수 있다.
  전세계 40대뿐이며 에센자 SCV12 고객 전용으로 한정판을 공개했다.</pre>
    </div>
                                            </article>
                                        </article>
                                    </article>
                                ...
                                <section id="writingFooter">
                                    ...
                                    <article id="writingBtn">
                                        <article id="writingBtnTag">
                                            <button id="jacBtn">수정</button> <button id="noWrite">취소</button>
                                        </article>
                                    </article>
                                </section>
                        </main>
    ...
    <script>
        document.querySelector("#jacBtn").addEventListener("click",()=>{
            alert("수정 등록은 추후 업데이트 예정입니다.")
        })

            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/globalNewsPosting.html"
            })
