                            ...
                            <section id="loginTag">
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="k3 세차 하고 왔습니다~!" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/carwash.PNG" width="30%" alt="carwash">
                                                    <pre>  날씨가 좋아서 세차하고 왔습니다
  오랜만에 세차하니까 기분도 좋고 시원하네요
  당분간 비가 안오기를 바래야겠습니다!ㅋㅋㅋㅋ</pre>
    </div>
                                            </article>
                                        </article>
                                    </article>
    ...
    <script>
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/korFreePosting.html"
            })
