                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">예비 차주 - 딜러 매칭</article>
                                ...
                                <section id="writing">
                                    <article id="writingtop">
                                        ...
                                        <select name="writeSel" id="writeSel">
                                            <option value="global">예비차주</option>
                                            <option value="kor">국산차</option>
                                            <option value="userPark">수입차</option>
                                            <option value="lateCar">만남의광장</option>
                                        
                                        </select>
                                        <select name="writeSel" id="writeSel">
                                            <option value="kor">딜러 매칭</option>
                                            <option value="kor">견적 문의</option>
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="안녕하세요. 서울 G80 딜러님 찾습니다~" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/latecar.jpg" width="50%" alt="latecar">
                                               <pre>  안녕하세요~ 서울지역 G80 딜러님 찾습니다.
  조건 : 선수금 4000 + 할부 60개월 입니다.
  딜러서비스랑 견적 댓글로 적어주세요~~!</pre>
    </div>
                                            </article>
                                        </article>
                                    </article>
    ...
    <script>
           document.querySelector("#jacBtn").addEventListener("click",()=>{
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/lateCarPosting.html"
            })
