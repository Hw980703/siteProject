                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">국산차 - 국내 자동차 뉴스</article>
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="'확 바뀐 얼굴, 더 바뀐 실내' 렉스턴 스포츠 칸 쿨멘" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/kornewswrite.jpg" width="40%" alt="kornews">
                                               <pre>  KG모빌리티가 주력 상품인 픽업트럭 '렉스턴 스포츠'에 '쿨멘'시리즈를 더했다.
  프랑스어로 '산 꼭대기'를 뜻하는데, 과연 이런 이름이 붙을만한 차인지 기대가 된다.
  가장 큰 변화는 외관이며 앞쪽 육각형 라디에이터 그릴은 팔각형으로 재탄생했다.</pre>
    </div>
                                            </article>
                                        </article>
                                    </article>
    ...
    <script>
           document.querySelector("#jacBtn").addEventListener("click",()=>{
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/korNewsPosting.html"
            })
