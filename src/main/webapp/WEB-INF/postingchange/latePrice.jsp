                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">예비 차주 - 견적 문의</article>
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="안녕하세요. 제네시스 g70 견적 궁금합니다" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/lateprice.jpg" width="40%" alt="lateprice">
                                               <pre>  제네시스 g70 견적 궁금합니다!
  조건은 3.3T 풀옵션으로 하고 싶은데요..
  견적이 얼마 정도 나올까요?</pre>
    </div>
                                            </article>
                                        </article>
    ...
    <script>
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/latePricePosting.html"
            })
