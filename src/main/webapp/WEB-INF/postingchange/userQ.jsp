                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">만남의 광장 - 질문 게시판</article>
                                ...
                                <section id="writing">
                                    <article id="writingtop">
                                        ...
                                        <select name="writeSel" id="writeSel">
                                            <option value="global">만남의광장</option>
                                        ...
                                        <select name="writeSel" id="writeSel">
                                            <option value="kor">질문 게시판</option>
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="제 상황에 차 바꿔도 될까요..?" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/userqna.jpg" width="50%" alt="userqna">
                                               <pre>  외벌이고 대출금 갚으면 남는돈이 많이 없는데.. 차 바꿔도 될까요?
  지금은 구형 k3 타고 있는데.. 곧 출산 예정이라서 suv로 바꾸고싶어서요.
  신형 스포티지 사려는데 괜찮을까요?</pre>
    </div>
                                            </article>
                                        </article>
                                    </article>
    ...
    <script>
           document.querySelector("#jacBtn").addEventListener("click",()=>{
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/userQnaPosting.html"
            })
