                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">수입차 - 베스트 인기 게시물</article>
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value=" 벤틀리 플라잉 스퍼 V8 시승기" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/globalbest.jpg" width="50%" alt="globalbest">
                                                    <pre>  벤틀리 플라잉 스퍼 V8 모델을 시승해봤습니다!
  8기통이라서 배기음 장난 아니네요 ㄷㄷ 외관 디자인도 미쳤습니다
  이번에 너무 잘나온거같아요! 또 타고싶어요 ㅎ</pre>
    </div>
                                            </article>
                                        </article>
                                    </article>
    ...
    <script>
        document.querySelector("#jacBtn").addEventListener("click",()=>{
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/globalBestPosting.html"
            })
