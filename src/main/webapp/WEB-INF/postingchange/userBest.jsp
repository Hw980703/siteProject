                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">만남의 광장 - 베스트 인기 게시물</article>
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="엔진오일 저렴하게 교체하는 꿀팁!" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/userbest.jpg" width="40%" alt="userbest">
                                               <pre>  엔진오일 저렴하게 교체하는 꿀팁 공유합니다 ㅎㅎ
  1.인터넷으로 엔진오일과 필터류를 구매한다.
  2.동네 공임나라에서 공임비만 주고 교체한다.
  3.끝입니다 ㅋㅋ 쉽쥬? </pre>
    </div>
                                            </article>
                                        </article>
    ...
    <script>
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/userBestPosting.html"
            })
