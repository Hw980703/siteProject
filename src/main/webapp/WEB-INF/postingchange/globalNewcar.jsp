                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">수입차 - 새차 인증 / 내 차 소개</article>
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="드디어 새 차 샀습니다!" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/globalnewcarwrite.jpg" width="50%" alt="carwash">
                                                    <pre>  드디어 벤츠 출고 했습니다!
  오래 기다린 만큼 너무 예쁘네요!
  안전운전 하면서 잘타겠습니다~</pre>
    </div>
    ...
    <script>
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/globalNewcarPosting.html"
            })
