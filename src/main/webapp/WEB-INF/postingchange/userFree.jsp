                            ...
                            <section id="loginTag">
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="에어컨 필터 언제언제 교체하시나요?" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/userfree.jpg" width="40%" alt="userfree">
                                               <pre>  회원님들은 에어컨 필터 언제마다 교체하시나요?
  저는 6개월마다 교체하는데 너무 늦는건가싶고..
  싼거 사서 자주 갈아주는게 좋나요?</pre>
    </div>
                                            </article>
                                        </article>
                                    </article>
    ...
    <script>
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/userFreePosting.html"
            })
