                            ...
                            <section id="loginTag">
                                ...
                                <section id="writing">
                                    ...
                                    <article id="writingCenter">
                                        <span>제목 </span> <input type="text" name="writeTitle" id="writeTitle" value="k5 페이스리프트 예상도라고 합니다" placeholder="제목을 입력하세요.">
                                    </article>
                                        ...
                                        <article id="writingMainSub">
                                            ...
                                            <article id="textArea">
                                                <div contenteditable="true" id="textDiv">
                                                    <img src="../resources/image/korbestwrite.jpg" width="50%" alt="korbestwrite">
                                               <pre>  이번 페이스리프트 예정인 K5 예상도라고 합니다.
  지금 모델이 더 예쁜거같은데 저만 그런가요..?
  회원님들은 어떠신가요?</pre>
    </div>
                                            </article>
                                        </article>
    ...
    <script>
            ...
            document.querySelector("#noWrite").addEventListener("click",()=>{
                location.href="../posting/korBestPosting.html"
            })
