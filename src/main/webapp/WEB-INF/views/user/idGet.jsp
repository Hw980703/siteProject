...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/userIdGet.css">
    </head>
    <body>
                        ...
                        <main id = "userSign">
                            <section id="signTag">
                                ...
                                <section id="signMain">
                                        ...
                                        <article id="idPwBtn" ><button id="idGetBtn">아이디 찾기</button> <button id="pwGetBtn" class="pwGetBtn1">비밀번호 찾기</button> </article>
                                        <article id="getText"><pre>카뮤니티 아이디를 잊으셨나요?
가입 당시 입력했던 핸드폰 번호를 입력하고
인증 후 아이디를 확인하실 수 있습니다!
                                        </pre></article>
                                        <article class="getInput" id="getName"> <button class="getBtn">이름</button><input type="text" name="getName" id="getNameInput" placeholder="이름을 입력하세요 한글4자리"></article>
                                        <article class="getInput"> <button class="getBtn">TEL</button><input type="text" name="getTel" id="getTelInput" placeholder="핸드폰 번호를 입력하세요 -제외]
                                            ">    <button id="numBtn1">인증번호 전송</button></article>
                                        <article class="getInput"> <button class="getBtn">인증</button><input type="text" name="getTelNum" id="getTelNumInput" placeholder="인증번호 숫자4자리"><button id="numBtn2">인증번호 확인</button></article>
                                        <article class="getInput"><button id="getBtnSub">아이디 찾기</button></article>
                                    </section>
                                    </section>
                    </main>
            <footer id="footer">
    ...
    <script>
        ...
        let tel;
            ...
            document.querySelector("#getBtnSub").addEventListener("click",()=>{
                ...
                window.open("./idPopup.html","",viewOpt)}else(alert("인증이 되지 않았습니다."))
            })
            ...
            if(telExp.test(telNum)){
                ...
                alert("인증번호가 발송되었습니다. 인증번호: " + num1 + num2 + num3 + num4)
        ...
        document.querySelector("#numBtn2").addEventListener("click",()=>{
            ...
            let telExp2 = /^[0-9]{4}$/g
            	...
            	if (tel) { // 인증번호 발송 여부 체크
            	    if (telExp2.test(telNum2)) {
            	      // 사용자가 입력한 인증번호와 발송한 인증번호를 비교하여 일치하면 인증 확인
            	      let enteredCode = telNum2;
            	      let sentCode = "" + num1 + num2 + num3 + num4; // 발송한 인증번호를 문자열로 변환하여 비교
            	      ...
            	      alert("인증번호 숫자 4자리를 입력해주세요.");
            	    }
            	  } else {
            	    alert("인증번호 발송이 되지 않았습니다. 인증번호 발송부터 해주세요.");
            	  }
            	});
