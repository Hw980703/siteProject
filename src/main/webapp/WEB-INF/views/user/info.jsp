                            ...
                            <section id="loginTag">
                                ...
                                <section id="infoChange">
                                    ...
                                    <article class="infoTag">
                                        <h4>닉네임</h4> &nbsp;&nbsp;&nbsp;&nbsp; ${member.memberNicName} &nbsp;&nbsp;&nbsp;&nbsp; <button class="changeBtn">변경 </button>
                                    </article>

                                    <article class="infoTag">
                                        <h4>아이디</h4> &nbsp;&nbsp;&nbsp;&nbsp; ${member.memberId } &nbsp;&nbsp;&nbsp;&nbsp; <button class="changeBtn">변경 </button>
                                    </article>
                                    <article class="infoTag">
                                        <h4>비밀번호</h4> &nbsp;&nbsp;&nbsp;&nbsp;************ &nbsp;&nbsp;&nbsp;&nbsp; <button class="changeBtn">변경 </button>
                                    </article>
                                    <article class="infoTag">
                                        <h4>이름</h4> &nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ${member.memberName } &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </article>
                                    <article class="infoTag">
                                        <h4>전화번호</h4> &nbsp;&nbsp;&nbsp;&nbsp; ${member.memberPhone } &nbsp;&nbsp;&nbsp;&nbsp; <button class="changeBtn">변경 </button>
                                    </article>
                                    <article class="infoTag">
                                        <h4>이메일</h4> &nbsp;&nbsp;&nbsp;&nbsp;  ${member.memberEmail} &nbsp;&nbsp;&nbsp;&nbsp; <button class="changeBtn">변경 </button>
                                    </article>
                                    	 <article class="infoTag"> 
...
<!--                                     </article> -->
                                    <article class="infoTag" id="infoEndTag">
                                        <button class="infoEnd" id="infoSave">저장</button> <button class="infoEnd" id="infoOut">회원탈퇴</button>
                                    </article>
                                    </article>
