...
<html lang="en">
                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">국산차 - 베스트 인기 게시물</article>
                                
                                </article>
                                <hr>
                                <section id="writeTitle">
                                    <article id="writeTitleText">
                                        k5 페이스리프트 예상도라고 합니다 [2]
                                    </article>
  ...
  회원님들은 어떠신가요?</pre>
                                    ...
                                    <article id="writegood">
                                        <button id="writeGoodBtn">추천 45</button>
                                    </article>
                                    <article id="writeBtn">
                                ...
                                <section id="writeMainFooter">
                                    <article id="comment1">
                                        종로구보안관 : 전 별로네요.. 지금 모델이 더 예뻐요.
                                    </article>
                                    <article id="comment2">
                                        강북구보안관 : 실제로 출시 되면 예쁘지 않을까요?
                                    </article>
    ...
    <script>
            ...
            document.querySelector("#writeChange").addEventListener("click",()=>{
                location.href="../postingchange/korBest.html"
            })
