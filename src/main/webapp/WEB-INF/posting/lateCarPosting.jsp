...
<html lang="en">
  ...
  딜러서비스랑 견적 댓글로 적어주세요~~!</pre>
                                    ...
                                    <article id="writegood">
                                        <button id="writeGoodBtn">추천 0</button>
                                    </article>
                                    <article id="writeBtn">
                                ...
                                <section id="writeMainFooter">
                                    <article id="comment1">
                                        강북딜러 : 안녕하세요. 제네시스 강북지점 딜러입니다. 블랙박스,선팅,PPF 등 서비스 가능합니다~
                                    </article>
                                    <article id="comment2">
                                        중구딜러 : 안녕하세요. 제네시스 중구지점 딜러입니다. 블랙박스 : QXD8000 선팅 : 솔라가드 PPF : 생활PFF 등 가능합니다!
                                    </article>
    ...
    <script>
            ...
            document.querySelector("#writeChange").addEventListener("click",()=>{
                location.href="../postingchange/lateCar.html"
            })
