...
<html lang="en">
  ...
  전세계 40대뿐이며 에센자 SCV12 고객 전용으로 한정판을 공개했다.</pre>
                                    ...
                                    <article id="writegood">
                                        <button id="writeGoodBtn">추천 12</button>
                                    </article>
                                    <article id="writeBtn">
                                ...
                                <section id="writeMainFooter">
                                    <article id="comment1">
                                        종로구보안관 : 우루스 퍼포만테 한정판 에디션 대박이네요..
                                    </article>
                                    <article id="comment2">
                                        강북구보안관 : 와 진짜 타보고싶군요 ㅜ
                                    </article>
    ...
    <script>
            ...
            document.querySelector("#writeChange").addEventListener("click",()=>{
                location.href="../postingchange/globalNews.html"
            })
