...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/userqna.css">
    </head>
    <body>
                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">카뮤니티 1대1 문의</article>
                                
                                </article>
                                <hr>
                                <section id="userQnaTitle">
                                    <article id="qnaTitleText" class="qnaText">
                                            <h1> 제목</h1>
                                    </article>
                                    <article id="qnaTitleInput" class="qnaInput">
                                        <input class = "qnaInputTag" type="text" name="qnaTitle" id="qnaTitle" placeholder="제목을 입력해주세요.">
                                    </article>
                                </section>
                                <section id="userQnaWrite">
                                    <article id="qnaWriteText" class="qnaText">
                                        <h1>내용</h1>
                                    </article>
                                    <article id="qnaWriteInput" class="qnaInput">
                                        <textarea rows="16" cols="72" placeholder="문의 내용을 입력해주세요."></textarea>
                                        </article>
                                 
                                </section>
                                <section id="userQnaFile">
                                    <article id="qnaFileText" class="qnaText">
                                        <h1> 첨부파일</h1>
                                    </article>
                                    <article id="qnaFileInput" class="qnaInput">
                                        <input class = "qnaInputTag" type="text" name="userFileText" id="userFileText" placeholder="파일을 첨부해주세요.">
                                        <input type="file" name="userFile" id="userFile">
                                    </article>
                                </section>
                                <section id="userQnaBtn">
                                    <button id="userQnaAdd">등록</button> <button>취소</button>
                                </section>
                            </section>
                        </main>
                            <!-- 맨 오른쪽 베스트 게시물 게시판 -->
