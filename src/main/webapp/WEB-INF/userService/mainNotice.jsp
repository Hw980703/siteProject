...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/mainNotice.css">
    </head>
    <body>
                            ...
                            <section id="loginTag">
                                ...
                                <section id="noticeTable">
                                    <table border="1">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td> <a href="./noticeWrite.html">6월 1일 홈페이지 업데이트</a></td>
                                            <td>운영자</td>
                                            <td>2023.05.21</td>
                                            <td>424</td>
                                        </tr>
                                        ...
                                        <section id="noticeBtn">
                                            <button id="noticeBtn1"><</button>
                                                <button id="noticeBtn2">1</button> 
                                                <button id="noticeBtn3">2</button> 
                                                <button id="noticeBtn4">3</button> 
                                                <button id="noticeBtn5">4</button> 
                                                <button id="noticeBtn6">></button> 
                                        </section>
