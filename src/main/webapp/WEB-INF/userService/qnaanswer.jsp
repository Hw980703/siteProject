...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/qnaanswer.css">
    </head>
    <body>
                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">-카뮤니티 1대1 문의 답변</article>
                                
                                </article>
                                <hr>
                                <section id="userQnaTitle">
                                    <article id="qnaTitleText" class="qnaText">
                                            <h1> 제목 : 안녕하세요! 문의 드립니다</h1>
                                    </article>
                                ...
                                <section id="userQnaWrite">
                                    <article id="qnaWriteText" class="qnaText">
                                            안녕하세요! 문의 드립니다 <br>
                                            카뮤니티 사이트 운영규정이나 사이트 이용규칙 등 <br>
                                            사용가이드가 궁금합니다!
                                        </article>
                                        <article id="qnaWriteBtn">
                                            <button id="writeBtn">수정</button> <button>삭제</button>
                                        </article>
                                </section>
                                  
                                    <h1>고객센터 답변</h1>
                                <section id="userQnaFile">
                                안녕하세요! 카뮤니티 고객센터입니다. <br>
                                저희 카뮤니티 사이트는 회원간 원활한 소통을 위해서 큰 규정은 없습니다. <br>
                                회원간 욕설 및 비방없는 이용 부탁드립니다. 감사합니다^^
                                </section>
