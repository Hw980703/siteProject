...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/userService.css">
    </head>
    <body>
                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">나의 민원</article>
                                ...
                                <br>
                             <h2> 1대1 문의 내역</h2> <button id="ililBtn">1대1 문의하기</button> <hr>
                                <section id="qnaTop">
                                    <article id="qnaTopLeft">
                                            <h1>문의 내용</h1>
                                    </article>
                                    <article id="qnaTopCenter">
                                            <h1>닉네임</h1>
                                    </article>
                                    <article id="qnaTopRight">
                                            <h1>날짜</h1>
                                    </article>
                                </section>
                                <section id="qnaFooter">
                                    <article id="qnaFooterLeft">
                                        <ol>
                                            <li> <a href="./qnaanswer.html"> 안녕하세요! 문의 드립니다 </a> [1]</li>
                                            <li> <a href="./qnaanswer.html"> 안녕하세요! 문의 드립니다 </a> [1]</li>
                                            <li> <a href="./qnaanswer.html"> 안녕하세요! 문의 드립니다 </a> [1]</li>
                                            <li> <a href="./qnaanswer.html"> 안녕하세요! 문의 드립니다 </a> [1]</li>
                                            <li> <a href="./qnaanswer.html"> 안녕하세요! 문의 드립니다 </a> [1]</li>
                                ...
                                <article id="myfooter">
                                    <article id="myLeft">
                                        <article id="myLeftTop">
                                                <h1>공지사항</h1>
                                        </article>
                                        <section id="myLeftMain">
                                            <article id="myLeft1">

                                         
                                            <ol>
                                                <li> <a href="./noticeWrite.html"> 6월 1일 홈페이지 업데이트 </a></li>
                                                <li> <a href="./noticeWrite.html"> 6월 1일 홈페이지 업데이트 </a></li>
                                                <li> <a href="./noticeWrite.html"> 6월 1일 홈페이지 업데이트 </a></li>
                                                <li> <a href="./noticeWrite.html"> 6월 1일 홈페이지 업데이트 </a></li>
                                                <li> <a href="./noticeWrite.html"> 6월 1일 홈페이지 업데이트 </a></li>
                                    ...
                                    <section id="myFooterRight">
                                        <article id="myFooterTop">
                                            <h1>고객센터</h1>
                                        </article>
                                        <article id="myFooterImg">
                                            <img id="footerImg" src="../resources/image/serviceImg.jpg" alt="serviceImg" width="100%">
                                        </article>
                                        <article id="myFooterRighttext">
                                            <h2>고객센터</h2>
                                            <h2>TEL : 010-1234-5678</h2>
                                            <h2>평일 : 오전 9시 ~ 오후 6시</h2>
                                            </article>
                                    </section>
                                    </article>
    ...
    <script>
        document.querySelector("#qnaRight").addEventListener("click",()=>
        {alert("건의/신고 기능은 추후 업데이트 예정 입니다.")})

            document.querySelector("#ililBtn").addEventListener("click",()=>{
