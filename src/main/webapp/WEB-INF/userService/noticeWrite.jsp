...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" a href="../resources/css/noticeWrite.css">
    </head>
    <body>
                        ...
                        <main id = "userSign">
                            <section id="loginTag">
                                ...
                                <article id="myTitle">
                                    ...
                                    <article id="myTitleTag">공지사항 <br> HOME > 고객센터 > 공지사항</article>
                                ...
                                <section id="writeTag">
                                    <section id="writeTitle">
                                        <article id="writeTitleText">
                                            <h1>제목 : 6월 1일 홈페이지 업데이트</h1>
                                        </article>
                                        <article id="writeTitledate">
                                            2023.05.21
                                        </article>
                                    </section>
                                    <section id="noticeWriteMain">
                                            <h1>6월 1일 홈페이지 업데이트 합니다.</h1>
                                            <h1>업데이트 점검 시간 : 오전 1시 ~ 오전 4시</h1>
                                            <h1>업데이트 점검 시간 내 홈페이지가 정상 작동 하지 않을 수 있습니다.</h1>
                                            <h1>감사합니다.</h1>
                                    </section>
                                    <section id="writeMainBtn">
                                        <button id="backNotice">목록</button>
                                    </section>
                                        <br>
                                    <hr>
                                    </section>
    ...
    <script>
        ...
        document.querySelector("#backNotice").addEventListener("click",()=>{
            location.href="./mainNotice.html"
        })
        var count =1;
        var globalcount=1;
        var usercount =1;
